...
def train(**kwargs):
    ...
    img_optimizer = Adam(img_model.parameters(), lr=opt.lr, weight_decay=5 * 10 ** -4)
    txt_optimizer = Adam(txt_model.parameters(), lr=opt.lr1)
